...
public class ToeicLRdetail extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_toeic_lrdetail);
        ...
        Button btnFulltestToeicLR = findViewById(R.id.btnFullTestToeicLR);
        btnFulltestToeicLR.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ToeicLRdetail.this,MainActivityQuiz.class);
